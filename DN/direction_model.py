...
class Network:
	...
	def build(self, inputData, keepProb=1.0):
		...
		self.upscore5_3 = self._upscore_layer(self.fcn5_3, params=self._params["direction/upscore5_3"],shape=tf.shape(self.fcn3_3))
		self.upscore4_3 = self._upscore_layer(self.fcn4_3, params=self._params["direction/upscore4_3"],shape=tf.shape(self.fcn3_3))
		...
		self.output = self._upscore_layer(self.fuse3_3,
										  params=self._params["direction/upscore3_1"],
