function generate_GT_cityscapes_unified(input_annotation, gt_output, figures, keys, downsampling, depth_bins,input_file)
% generates 2 channel unitvec gt
    ...
    % annotation(annotation != classId) = 0;
    
    %annotation(~(annotation==keys(1) | ...
    %             annotation==keys(2) | ...
    %             annotation==keys(3) | ...
    %             annotation==keys(4) | ...
    %             annotation==keys(5) | ...
    %             annotation==keys(6) | ...
    %             annotation==keys(7) | ...
    %             annotation==keys(8))) = keys(9);
    
    
    annotation(annotation == -1) = keys(35);
    ...
    %save(gt_output, 'depth_map', 'dir_map', 'weight_map');
    if figures
        disp(input_file);
        figure(1);
        imagesc(depth_map);
